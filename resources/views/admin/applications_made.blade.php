            ...
            <div class="container grid px-6 mx-auto">
                ...
                >
                    <div class="flex items-center">
                        ...
                        <span>Applications made in GigsLink Africa</span>
                    </div>
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        <form action="/admin/confirmed_application" method="POST">
                            @csrf
                        <table class="w-full whitespace-no-wrap">
                            ...
                            >
                            @foreach($new_application->sortBy('Job_ID') as $n)
                        ...
                        >
                          {{$n->Your_Name}}
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <a href="{{$n->Portfolio_Website}}" target="_blank">{{$n->Portfolio_Website}}</a>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                    <a style="font-size: 1.2rem;color: blue" href="{{ route('download', ['filename' => $n->cv_file]) }}">Download applicant_cv</a>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <button  type="button"
                                            ...
                                            aria-label="Delete"
                                        >
                                            <input type="checkbox" name="confirmed_applications[]" value="{{$n->id}}">
                                        </button>
                                    </div>
                                </td>
                            </tr>
