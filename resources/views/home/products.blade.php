...
<section class="section" id="testimonials" style="padding-top: 120px">
    <div class="container">
        ...
        <ul class="nav nav-tabs" role="tablist" style="display: flex; justify-content: space-around; background-color: #f5f5f5; padding: 10px;">
            <li role="presentation" class="active"><a href="#t-series" aria-controls="t-series" role="tab" data-toggle="tab">M SERIES</a></li>
            <li role="presentation"><a href="#i-series" aria-controls="i-series" role="tab" data-toggle="tab">I SERIES</a></li>
            <li role="presentation"><a href="#j-series" aria-controls="j-series" role="tab" data-toggle="tab">J SERIES</a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="i-series">
                ...
                <div class="earnings_list" style="padding-bottom: 0px">
                    ...
                    {{--    <a class="earnings_item_btn" href="javascript:void(0);" onclick="Invest();">Purchase $ 43.5</a>--}}
            ...
            <div class="earnings_list" style="padding-bottom: 0px">
                <div class="earnings_item">
                    ...
                    {{--        <a class="earnings_item_btn" href="javascript:void(0);" onclick="Invest();"> Purchase $ 125 </a>--}}
            ...
            <div class="earnings_list" style="padding-bottom: 0px">
                <div class="earnings_item">
                    <a href="{{route('productdetail', ['name'=> 'I-420 MACHINE', 'invite' => '2', 'img' =>'mac5.jpeg','totrevcy'=>'60' , 'dyin'=>'5.6', 'totin'=>'339', 'retrate'=>'30', 'totretrate'=>'420', 'mspr'=>'2','pur'=>'262.5'])}}">
                        ...
                        {{--            <a class="earnings_item_btn" href="javascript:void(0);" onclick="Invest( );">Purchase $ 262.5 </a>--}}
            ...
            <div role="tabpanel" class="tab-pane active" id="t-series">
                <div class="earnings_list" style="padding-bottom: 0px">
                    <div class="earnings_item">
                        <a href="{{route('productdetail', ['name'=> 'M-42 MACHINE', 'invite' => '3', 'img' =>'machine1.jpeg','totrevcy'=>'15' , 'dyin'=>'3.9375', 'totin'=>'59', 'retrate'=>'15', 'totretrate'=>'225', 'mspr'=>'1','pur'=>26.25])}}">
                            <div class="mycount">Invite prize $3</div>
                            <div class="earnings_item_top">
                                <div class="earnings_img">
                                    <div class="earnings_vip"></div>
                        ...
                        <!-- Updated button text to include the product and price -->
                        <a class="earnings_item_btn" href="{{ Auth::check() ? 'javascript:void(0);' : route('login') }}" onclick="{{ Auth::check() ? "Invest('M-42 MACHINE', '3', 'machine1.jpeg', '15', '3.9375', '59.0625', '15', '225', '1', 26.25);" : '' }}">
    ...
    <div class="earnings_list" style="padding-bottom: 0px">
        <div class="earnings_item">
            <a href="{{route('productdetail', ['name'=> 'J-53MACHINE', 'invite' => '2', 'img' =>'mach5.jpeg','totrevcy'=>'40' , 'dyin'=>'1.3', 'totin'=>'33', 'retrate'=>'30', 'totretrate'=>'210', 'mspr'=>'1','pur'=>'31.2'])}}">
                <div class="mycount">Invite prize $2</div>
                <div class="earnings_item_top">
                    <div class="earnings_img">
                        <div class="earnings_vip"></div>
                ...
                {{--            <a class="earnings_item_btn" href="javascript:void(0);" onclick="Invest();">Purchase $ 3.2 VIA MPESA</a>--}}

                <a class="earnings_item_btn" href="{{ Auth::check() ? 'javascript:void(0);' : route('login') }}" onclick="{{ Auth::check() ? "Invest( 'J-53 MACHINE', '2', 'mach5.jpeg', '40', '1.3', '33', '30', '210', '1', '31.2');" : '' }}">
                    {{ Auth::check() ? 'Purchase $ 31.2' : 'Login to Purchase' }}
                </a>
        </div>
    </div>
    </div>
